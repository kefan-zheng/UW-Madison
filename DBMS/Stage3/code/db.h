...
class File {
 ...
 public:
  ...
  const Status readPage(const int pageNo, Page* pagePtr) const;       // read page from file
  const Status writePage(const int pageNo, const Page* pagePtr);      // write page to file
 ...
 private: 
  ...
  const Status intread(const int pageNo, Page* pagePtr) const;        // internal file read
  const Status intwrite(const int pageNo, const Page* pagePtr);       // internal file write
