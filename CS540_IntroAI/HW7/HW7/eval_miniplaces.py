...
def evaluate_models_in_different_configs():
    results = []
    # args setting
    ...
    # 1
    args = parser.parse_args(['--load', './outputs/1/model_best.pth.tar'])
    results.append(main(args))
    # 2
    args = parser.parse_args(['--load', './outputs/2/model_best.pth.tar'])
    results.append(main(args))
    # 3
    args = parser.parse_args(['--load', './outputs/3/model_best.pth.tar'])
    results.append(main(args))
    # 4
    args = parser.parse_args(['--load', './outputs/4/model_best.pth.tar'])
    results.append(main(args))
    # 5
    args = parser.parse_args(['--load', './outputs/5/model_best.pth.tar'])
    results.append(main(args))
    # 6
    args = parser.parse_args(['--load', './outputs/6/model_best.pth.tar'])
    results.append(main(args))
    # 7
    args = parser.parse_args(['--load', './outputs/7/model_best.pth.tar'])
    results.append(main(args))
...
if __name__ == '__main__':
    evaluate_models_in_different_configs()
